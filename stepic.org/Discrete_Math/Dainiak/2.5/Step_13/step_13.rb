...
################################################################################
# Для заданного графа и заданной стартовой вершины выпишите вершины
# a,b,…,l, в том порядке, в котором они посещаются каким-нибудь обходом в
# глубину. Ответ нужен в том же формате, как и в предыдущей задаче.
#
